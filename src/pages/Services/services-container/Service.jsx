...
const Service = () => {
  ...
  useEffect(() => {
    if (location.hash === '#dentalservices') {
      const el = document.getElementById('dentalservices');
      if (el) {
        const yOffset = -80; // adjust for any fixed header height
  ...
  return (
    <>
      <section>
          <div id="dentalservices" className="services-container">
